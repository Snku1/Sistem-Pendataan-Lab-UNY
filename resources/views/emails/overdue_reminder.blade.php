...
<body>
    <div class="container">
        <div class="header">
            <h1>⚠️ Peringatan Keterlambatan</h1>
        ...
        <div class="content">
            ...
            <p>Peminjaman barang dengan kode transaksi <strong>{{ $peminjaman->kode_transaksi }}</strong> telah <strong>melewati batas waktu pengembalian</strong> selama <strong>{{ $daysOverdue }} hari</strong>.</p>
            <p>Segera lakukan pengembalian barang ke laboratorium untuk kelancaran layanan bersama.</p>
            ...
            <table class="detail-table">
                ...
                <tr>
                    <th>Keterlambatan</th>
                    <td style="color: #dc3545; font-weight: bold;">{{ $daysOverdue }} hari</td>
                </tr>
                <tr>
            ...
            <div class="alert-box">
                <strong>⚠️ Perhatian:</strong> Pengembalian yang terlambat dapat mengganggu ketersediaan barang untuk pengguna lain. Harap segera mengembalikan barang ke laboratorium.
            </div>
