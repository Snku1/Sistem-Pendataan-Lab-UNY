...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold">Tambah Laboratorium</h2>
    ...
    <div class="card-body p-4">
        <form action="{{ route('admin.laboratorium.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_lab" class="form-control @error('nama_lab') is-invalid @enderror" value="{{ old('nama_lab') }}" required>
                @error('nama_lab')
