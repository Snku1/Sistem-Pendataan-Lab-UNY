            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="role" id="role" class="form-select @error('role') is-invalid @enderror" required>
                        ...
                        <option value="koorlap" {{ old('role', $user->role) == 'koorlap' ? 'selected' : '' }}>Koordinator Lab</option>
                ...
                <div class="col-md-6 mb-3" id="lab-field">
                    ...
                    <select name="id_lab" class="form-select @error('id_lab') is-invalid @enderror">
                        ...
                        @foreach($laboratorium as $lab)
                            <option value="{{ $lab->id_lab }}" {{ old('id_lab', $user->id_lab) == $lab->id_lab ? 'selected' : '' }}>{{ $lab->nama_lab }}</option>
                        @endforeach
                    </select>
