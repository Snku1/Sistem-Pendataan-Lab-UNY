...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold">Tambah Penanggung Jawab</h2>
    ...
    <div class="card-body p-4">
        <form action="{{ route('admin.penanggung-jawab.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_pj" class="form-control @error('nama_pj') is-invalid @enderror" value="{{ old('nama_pj') }}" required>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Pilih lab jika penanggung jawab ini spesifik untuk lab tertentu. Biarkan kosong untuk global.</small>
            </div>
            <div class="mt-4">
