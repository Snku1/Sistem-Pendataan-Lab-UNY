...
class BarangSeeder extends Seeder
{
    ...
    {
        $lokasi = Lokasi::first();
        // Jika ingin mengisi semester default (misal semester aktif), bisa ambil semester dengan is_active = 1
        $semester = Semester::where('is_active', true)->first();
        $semesterId = $semester ? $semester->id_semester : null;
        ...
        foreach ($barangList as $barang) {
            ...
            $barang['id_semester'] = $semesterId; // set semester aktif atau null
